...
- Each ESL chapter folder has a `ch{N}_helpers.py` module; AFML chapters use `fml_ch{N}_helpers.py` for plot helpers and `maths_self_study.data.fml` for shared BTC data loaders
