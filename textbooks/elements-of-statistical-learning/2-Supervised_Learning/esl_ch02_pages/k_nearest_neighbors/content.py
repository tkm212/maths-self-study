...
from esl_ch02_data import load_xy
...
def render_body(max_rows, k_neighbors) -> html.Div:
    ...
    try:
        fig, summary = esl_ch02_helpers.knn_train_test_mse_figure(X, y, max_rows=max_rows)
        fig2, _feat = esl_ch02_helpers.linear_vs_knn_single_feature_figure(
