...
CH7_DASHBOARD = REPO_ROOT / "textbooks/deep-learning/7-Regularization_for_Deep_Learning/dashboard.py"
CH8_DASHBOARD = REPO_ROOT / "textbooks/deep-learning/8-Optimization_for_Training_Deep_Models/dashboard.py"
